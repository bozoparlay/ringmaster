...
### Speed up Add Task
**Priority**: Critical | **Effort**: High | **Value**: High
**Branch**: task/fa124fd6-speed-up-add-task
**Worktree**: .tasks/task-fa124fd6
...
**Notes**: I've noticed that as is hitting add task can hang the process to where i need to kill things, which is extremely painful
