...
### Fix tile drag from Up Next tasks
<!-- ringmaster:id=4ce41df4-ebb1-45b3-ac3f-d575055486d2 -->
**Priority**: Medium | **Effort**: Medium | **Value**: Medium

**Description**:
When dragging tiles from the backlog that are also in up next, the tile is shifted over away from the mouse. Fix it to where wherever the tile is dragged from it doesn't shift under the mouse.
