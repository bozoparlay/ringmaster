...
import { HookSetupPanel } from './HookSetupPanel';

// ============================================================================
// Types
// ============================================================================

type SettingsSection = 'ai' | 'workflow' | 'git' | 'tasks' | 'github' | 'integrations';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-surface-500 mt-1">Connect external tools and services</p>
        </div>
      </div>
