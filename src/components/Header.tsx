          ...
          {(onCleanup || onCleanupWorktrees) && (
            <ActionDropdown
              ...
              actions={[
                ...
                ...(onCleanupWorktrees ? [{
                  id: 'worktrees',
                  label: 'Clean Local Worktrees',
                  icon: (
                    // Git branch icon - clean worktree visualization
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                      {/* Main trunk */}
                      <rect x="6" y="5" width="4" height="14" rx="2" />
                      {/* Branch connector */}
                      <rect x="8" y="10" width="9" height="4" rx="2" />
                      {/* Top node */}
